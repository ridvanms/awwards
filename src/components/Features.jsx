    ...
    <section className='bg-black pb-52'>
        <div className="container mx-auto px-3 md:px-10">
            <div className="px-5 py-32">
                ...
                <p className='max-w-md font-circular-web text-lg text-blue-50 opacity-50'>Immerse yourself in a rich and ever-expending universe where a vibrant array of products converge into an interconnected overlay experience on your world
                </p>
            </div>
        <div className="border-hsla relative mb-7 h-96 w-full overflow-h-hidden rounded-md md:h-[65vh]">
            <BentoCard
                ...
                description="A new way to experience the world"
                isComingSoon
                />
        </div>
        <div className="grid h-[135vh] grid-col-2 grid-row-3 gap-7">
                ...
                <BentoTilt className="bento-tilt_2 row-span-1 ms-32 md:col-span-1 md:ms-0">
                    <BentoCard
                        src={`public/videos/feature-3.mp4`}
                        title={<>n<b>e</b>xus</>}
                        description="The game is just the beginning"
                    />
                 </BentoTilt>
                <BentoTilt className="bento-tilt_2 me-14 md:col-span-1 md:me-0">
                    <BentoCard
                        ...
                        title={<>az<b>u</b>l</>}
                        description="World class entertainment"
                    />
                </BentoTilt>
